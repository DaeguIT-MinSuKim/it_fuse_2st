...
('C001', '김유정', '010-1111-1234','04524','서울특별시 중구 세종대로 110','',false, password('1234'), 'C', true, 0, 2, 2, '9999-99-99'),
('C002', '박보영', '010-1234-2255','35242','대전광역시 서구 둔산로 100','',false, password('4567'), 'C', true, 1, 2, 2, '9999-99-99'), 
('C003', '박보영', '010-2222-4567','41911','대구광역시 중구 공평로 88','',false, password('5864'), 'C', true, 0, 4, 1, '9999-99-99'),
('C004', '전지현', '010-7777-2255','47545','부산광역시 연제구 중앙대로 1001','',false, password('aaba'), 'C', true, 0, 5, 4, '9999-99-99'),						-- 4권 빌린사람
('C005', 'Emma Watson', '010-5555-4567','41908','대구광역시 중구 국채보상로139길 1','',false, password('bbbb'), 'C', false, 1, 7, 5, '9999-99-99'),            -- 5권 빌린사람
('C006', '고수', '010-1234-1234','41185','대구광역시 동구 아양로 207','',true, password('8888'), 'C', false, 0, 1, 0, '9999-99-99'), -- 탈퇴상태
('C007', '박보검', '010-5432-1234','41777','대구광역시 서구 국채보상로 257','',false, password('9595'), 'C', false, 0, 3, 1, '9999-99-99'),            -- 탈퇴회원
('C008', '박형식', '010-1234-9999','42429','대구광역시 남구 이천로 51','',false, password('5555'), 'C', false, 1, 4, 2, '9999-99-99'),            -- 책 연체 중인 사람(일반)
('C009', 'Dan Stevens', '010-9876-1200','41590','대구광역시 북구 옥산로 65','',false, password('4444'), 'C', true, 2, 6, 2, '9999-99-99'),               -- 곧 블랙.. 연체횟수 2번이나 연체중 아님
('C010', '원빈', '010-9876-5432','42424','대구 남구 중앙대로 220 3층','',false, password('8811'), 'C', false, 2, 6, 2, '9999-99-99'),             -- 곧 블랙리스트 될 사람.. 연체횟수2번에 연체중인사람
('C011', '원빈', '010-234-1234','42424','대구 남구 중앙대로 220 3층','',false, password('8811'), 'C', false, 3, 5, 0, '2017-04-23'), 	-- 현재 블랙리스트
('A001', '관리자', '010-234-1234','42424','대구 남구 중앙대로 220 3층','',false, password('admin'), 'A', false, 0, 0, 0, '9999-99-99'), -- 관리자
('B001', '사서', '010-234-1234','42424','대구 남구 중앙대로 220 3층','',false, password('8811'), 'B', false, 0, 0, 0, '9999-99-99');      -- 사서
UPDATE book_project.memberinfo SET is_secsn=true WHERE m_code='C006';

select*from book_project.memberinfo;
...
A001,*4ACFE3202A5FF5CF467898FC58AAB1D615029441,관리자,010-234-1234,42424,대구 남구 중앙대로 220 3층,false,0,0,0,'',A,false,
B001,*B6B0BC04CCD6F63D134115A53FB3159F7974F05F,사서,010-234-1234,42424,대구 남구 중앙대로 220 3층,false,0,0,0,'',B,false,
C001,*A4B6157319038724E3560894F7F932C8886EBFCF,김유정,010-1111-1234,04524,서울특별시 중구 세종대로 110,true,0,2,2,,C,false,
C002,*91C56982E0A5E9D4CEB104DC61A1538840B5D77D,박보영,010-1234-2255,35242,대전광역시 서구 둔산로 100,true,1,2,2,'',C,false,
C003,*0BB204F9DAB6BE00899171E792591B2B38F7CF31,박보영,010-2222-4567,41911,대구광역시 중구 공평로 88,true,0,4,1,'',C,false,
C004,*70E4B4C9B6D246F7D7D79632DAC29958165E1D5B,전지현,010-7777-2255,47545,부산광역시 연제구 중앙대로 1001,true,0,5,4,'',C,false,
C005,*367BE0AF56D3C7A0A3C1725AFBC9D25E1E95C36E,Emma Watson,010-5555-4567,41908,대구광역시 중구 국채보상로139길 1,false,1,7,5,'',C,false,
C006,*79F03894C8051E03949A9F87C0824822405C5079,고수,010-1234-1234,41185,대구광역시 동구 아양로 207,false,0,1,0,'',C,true,
C007,*5604FA7410203956AB2DA52E7225EE60DBF77E3A,박보검,010-5432-1234,41777,대구광역시 서구 국채보상로 257,false,0,3,1,'',C,false,
C008,*F4435C61EFF2F5DEF2662E4D30C59617D2B65FA7,박형식,010-1234-9999,42429,대구광역시 남구 이천로 51,false,1,4,2,'',C,false,
C009,*38DF00F36027E4EA7B7B269C0ECD0616CCC1370A,Dan Stevens,010-9876-1200,41590,대구광역시 북구 옥산로 65,true,2,6,2,'',C,false,
C010,*B6B0BC04CCD6F63D134115A53FB3159F7974F05F,원빈,010-9876-5432,42424,대구 남구 중앙대로 220 3층,false,2,6,2,'',C,false,
C011,*B6B0BC04CCD6F63D134115A53FB3159F7974F05F,원빈,010-234-1234,42424,대구 남구 중앙대로 220 3층,false,3,5,0,2017-04-23,C,false,
