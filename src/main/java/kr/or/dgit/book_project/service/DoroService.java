...
import kr.or.dgit.book_project.dao.DoroMapper;
import kr.or.dgit.book_project.dao.DoroMapperImpl;
...
public class DoroService {
	...
	private String namespace = "kr.or.dgit.book_project.dao.DoroMapper.";
